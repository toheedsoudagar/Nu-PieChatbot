...
# ADDED: Utility for filtering metadata
from langchain_community.vectorstores.utils import filter_complex_metadata 

from langchain_unstructured.document_loaders import UnstructuredLoader # This replaces UnstructuredFileLoader
...
def run_ingestion_if_needed():
    ...
    if not os.path.exists(DB_DIR) or len(os.listdir(DB_DIR)) == 0:
        ...
        # FIX: Filter complex metadata before building the vector store
